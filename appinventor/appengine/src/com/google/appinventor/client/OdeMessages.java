...
public interface OdeMessages extends Messages, AutogeneratedOdeMessages {
  ...
  //DesignSettings
  @DefaultMessage("Design Settings")
  @Description("Text On Design Settings Button and Dialog")
  String designSettingsText();

  @DefaultMessage("Select Design")
  @Description("Selecting skin and toggling light/dark mode")
  String selectDesignTitle();

  @DefaultMessage("Descriptions")
  @Description("Descriptions of different skins and switching light/dark mode")
  String descriptionsTitle();
  ...
  @Description("Title for Toolkit custom editor.")

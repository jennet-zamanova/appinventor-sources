 ...
 */
public final class DiffSourceStructureBoxFilter implements ISourceStructureBox {
   ...
   */
  public DiffSourceStructureBoxFilter(DiffSourceStructureBox container) {
    super();
  ...
  private final class SelectSourceView implements Command {
    ...
    public void execute() {
      ...
      DiffSourceStructureBoxFilter.this.setView(view);

 ...
 *
 */
public final class DiffAssetListBox extends Box {
  // Singleton asset list box (only one asset list box allowed)
  private static final DiffAssetListBox INSTANCE = new DiffAssetListBox();
   ...
   */
  public static DiffAssetListBox getAssetListBox() {
    return INSTANCE;
  }

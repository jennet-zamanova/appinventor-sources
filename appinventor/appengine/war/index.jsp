<%@page
import="com.google.appinventor.server.Server,com.google.appinventor.common.version.AppInventorFeatures"
%> <% if (request.getScheme().equals("http") && Server.isProductionServer() &&
AppInventorFeatures.enableHttpRedirect()) { String qs =
request.getQueryString(); String host = request.getServerName(); if (qs != null)
{ String redirect = "https://" + host + "/?" + qs;
response.sendRedirect(redirect); } else { String redirect = "https://" + host;
response.sendRedirect(redirect); } return; } if
...
<html>
  <head>
    ...
    <link
      type="text/css"
      rel="stylesheet"
      href="static/closure-library/closure/goog/css/dialog.css"
    />
    <link
      type="text/css"
      rel="stylesheet"
      href="static/closure-library/closure/goog/css/hsvapalette.css"
    />
    <link
      type="text/css"
      rel="stylesheet"
    ...
    <link
      type="text/css"
      rel="stylesheet"
      href="static/leaflet/leaflet.toolbar.css"
    />
    <link
      type="text/css"
      rel="stylesheet"
      href="static/leaflet/leaflet-vector-markers.css"
    />
    ...
    <link
      type="text/css"
      rel="stylesheet"
      href="static/css/android_material.css"
    />
  ...
  <body class="gwt-bodyRob">
    ...
    <script
      ...
      src="static/closure-library/closure/goog/base.js"
    ></script>

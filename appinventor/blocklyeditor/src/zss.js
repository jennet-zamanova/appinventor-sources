...
function mapping (rootOfT1, rootOfT2, childrenOf, insertCost, removeCost, updateCost) {
  // Paper: "Preprocessing"
  var T1 = preprocess(rootOfT1, childrenOf)
  var T2 = preprocess(rootOfT2, childrenOf)

  // console.log("Preprocessed T2:", JSON.stringify(T2.nodes, null, 2));
  ...
  // console.log("nodes in 1: ", JSON.stringify(T1nodes, null, 2), " nodes in 2: ", JSON.stringify(T2nodes, null, 2));
...
zhangShasha.treeEditDistance = mapping;